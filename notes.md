...
prompt and response, regime engineering
ndando technical specification
imaniOS technical specification
...
try now to produce a distilled, digestible, simple medium style blog post of everything we have discussed, and attempt to include as much as you can without over emphasing any part of our conversation. At a minimum include regime programming, ndando  programming language, Imani OS, human-AI-joint cognitive/intelligence architecture and design, LLMs and the real meaning of "black boxes", AI-humans not just being user<->model/tool but joint coevolutionary system where AI is a reflective substrate that can mirror (and extent) human intelligence/cognitation, Ka/Ni/Se and songhai-model, mungu theory, and the implications of everything that we have discussed up to this point
